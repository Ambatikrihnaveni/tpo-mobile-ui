...
import ProductQuery from "../../../../client/ui/graphql/services/modules/queries/module";
import PublishProductsToCatalogMutation from "../../../../client/ui/graphql/services/modules/mutations/publishProductsToCatalog";
import UpdateProductMutation from "../../../../client/ui/graphql/services/modules/mutations/updateProduct";
...
function useProduct(args = {}) {
    ...
    try {
      ...
      if (redirectOnCreate) {
        if (data && parentIdLocal === product._id) {
          ...
          navigate(`/${shopIdLocal}/products/${product._id}/${newVariantId}`);
        } else {
          const newOptionId = data.createProductVariant && data.createProductVariant.variant && data.createProductVariant.variant._id;
          navigate(`/${shopIdLocal}/products/${product._id}/${parentIdLocal}/${newOptionId}`);
        }
      }
  ...
  }, [createProductVariant, enqueueSnackbar, product, refetchProduct, shopId]);
  ...
  }, [archiveProductVariants, enqueueSnackbar, option, product, refetchProduct, shopId, variant]);
