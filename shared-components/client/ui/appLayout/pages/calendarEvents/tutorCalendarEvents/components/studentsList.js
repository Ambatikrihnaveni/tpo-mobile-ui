...
function StudentsList({ scrollHeight, record }) {
        ...
        <List >
          {
            filteredStudents?.map((student, index) => (
              ...
              >
                ...
                <ListItemAvatar >
                  <Avatar src={`${filesBaseUrl}${(student?.userMedia) ? student?.userMedia[0]?.URLs?.thumbnail : ''}`} alt={student.name} />
                </ListItemAvatar>
                <ListItemText
                  ...
                  primary={
                    <Typography variant={"body1"} component={"div"}>
                      <Stack direction={"row"} alignItems={"center"} sx={{ minWidth: 0 }} onClick={() => viewProfile(student._id)}>
                        ...
                        >
                          <Typography variant={"h5"} fontSize={14} lineHeight={1.25} mb={0} sx={{textTransform:'capitalize'}}>
