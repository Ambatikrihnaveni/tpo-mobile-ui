...
import RejectedjobDetails from '../RecordDetail/rejectedjobDetails';
...
const RejectjobItem = ({ record, view }) => {
    ...
    const showRejectedDetail = React.useCallback(() => {
        showDialog({
            ...
            content: <RejectedjobDetails record={record} onClose={hideDialog} />
        })
    }, [showDialog, record]);
                    ...
                    <CardContent sx={{ pt: 0 }}>
                        ...
                        <List disablePadding>
                            ...
                            <ListItem style={{ marginTop: "-80px"}}>
                                <CalendarMonthIcon sx={{ minWidth: 50, color: "#50c2c9", marginTop: "-70px",marginLeft:"-12"}}>
                                    <CalendarMonthIcon />
                                </CalendarMonthIcon>
                                <ListItemText
                                    sx={{
                        ...
                        >
                            ...
                            >
                                <Button variant="contained" color={buttonText == "Placed" ? "success" : buttonText == "Apply" ? "warning" : buttonText == "Applied" ? "primary" : 'error'} onClick={showtutorDetail} style={{ textTransform: 'none', borderRadius: '15px', minWidth: '100px',marginTop:"15px"}}>Rejected</Button>
                            </Item>
                        </Div>
    ...
    return (
        <React.Fragment>
            ...
            >
                    ...
                    primary={
                        <Typography variant={"body1"} component={"div"}>
                            ...
                            <Item
                                ...
                                >
                                    <Typography variant={"h5"} fontSize={14} lineHeight={1.25} mb={0} onClick={showRejectedDetail}
                ...
                >
                    <Button variant="contained" sx={{ borderRadius: "50px", marginLeft: "60px", backgroundColor: "#e74c3c", borderRadius: '15px', minWidth: '100px' }} onClick={showRejectedDetail}>  Rejected</Button>
                    {/*  <Select
                        value={record.status}
                        size="small"
                        sx={{ '.MuiOutlinedInput-notchedOutline': { border: 0 }, "&.Mui-focused .MuiOutlinedInput-notchedOutline": { border: 0 }, color: "white", borderRadius: "30px", width: "auto", height: "30px", fontSize: 12, textAlign: "center", backgroundColor: record.status === 'Approved' ? '#28a745' : record.status === 'Pending' ? '#f29339' : '#e73145', }}
                ...
                <Item>
                    ...
                    {/*  <ThumbUpOffAltIcon/>
                    <ThumbDownOffAltIcon/> */}
                   {/*  <a href={record.jobLink} target="_blank"> <LaunchIcon /></a>
                    <DeleteOutlineIcon /> */}
