...
export default function CertifiTemp_2({ logo, authority, studentName, trainingpartnerName, programName, startDate, endDate, programType,record }) {
    ...
    return (
        <Div sx={{ marginLeft: '100px' }}>
            ...
            <Div sx={{ mt: 4 }}>
                ...
                > {studentName ? studentName : 'Student Name'}</Typography>
                <Divider sx={{ backgroundColor: '#0e1857', height: '4px', width: '75%', margin: 'auto' }} />
                <Div sx={{ mt: 2 }}>
                ...
                <Div sx={{ textAlign: 'center', mt: 2 }}>
                    <img src={'/logo192.png'} width='100px' height='50px' style={{ padding: '10px' }} />
                    <img src={'/prahanSoft.png'} width='100px' height='50px' style={{ padding: '10px' }} />
                </Div>
            </Div>
        </Div>
    )
