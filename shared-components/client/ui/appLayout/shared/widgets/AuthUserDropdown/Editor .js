...
const Edit = ({ info, addInfo, handleCheck, handleCloseEditDialog }) => {
  ...
  return (
    <div>
      <h2 style={{ width: '100%', color: '#475259', paddingLeft: '30px', paddingTop: '30px', fontFamily: '"Domine",Georgia,serif', fontFamily: '"Domine",Georgia,serif', marginBottom: '10px', fontWeight: '700', fontSize: '2rem' }}>Additional Information</h2>
