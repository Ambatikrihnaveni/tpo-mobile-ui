...
export default function ColumnSpacing() {
  return (
    <div>
      <Typography variant="h3" sx={{ color: "black" }}>Create a new</Typography>
      <Typography variant="h4" >Select Content type</Typography>
      <Box sx={{ width: '40%' }}>
        <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
          <Grid item xs={12} md={6} lg={4} sx={{ mt: 4, borderStyle: "solid" }}>
            ...
            <Typography variant="h3" sx={{ color: "black" }}>Lesson</Typography>
            <Typography variant="h5">
              Delivery core theory and
            </Typography>
            <Typography>concepts</Typography>
          </Grid>
          <Grid item xs={12} md={6} lg={4} sx={{ mt: 4, borderStyle: "solid", ml: 8 }}>
            <Typography>
              <IconButton sx={{
                bgcolor: '#385196', color: 'common.white', p: theme => theme.spacing(1.25), '&:hover': {
                  backgroundColor: '#385196',
            ...
            <Typography variant="h3" sx={{ color: "black" }}>Quizes</Typography>
            <Typography>Promote Knowledge</Typography>
            <Typography>sharing with peers</Typography>
          </Grid>
          <Grid item xs={12} md={5} lg={4} sx={{ mt: 4, borderStyle: "solid" }}>
            <Typography>
              <IconButton sx={{
                bgcolor: '#385196', color: 'common.white', p: theme => theme.spacing(1.25), '&:hover': {
                  backgroundColor: '#385196',
            ...
            <Typography variant="h3" sx={{ color: "black" }}>Assignments</Typography>
