...
export default function FAQ({ FAQdata, handleFaqQuestionChange, handleFaqanswerChange, handleFaqTypeChange, handleAddFAQ, handleDeleteUser, handleAddQuestion, handleDeleteFAQ, recordType }) {
