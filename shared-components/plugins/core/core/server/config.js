...
export default envalid.cleanEnv(process.env, {
  ...
  PUBLIC_OPEN_AI_TOKEN: str({
    desc: "The canonical root URL for the Reaction Admin server",
    example: "c40e62ae76cd418f894e8d807bb60b77"
  }),
  PUBLIC_SUPERAGENT_API_TOKEN: str({ 
    desc: "The canonical root URL for the Reaction Admin server",
    example: "c40e62ae76cd418f894e8d807bb60b77"
  }),
  PUBLIC_SUPERAGENT_ID: str({
    desc: "The canonical root URL for the Reaction Admin server",
    example: "cljgj96t2000nrt1li67tdsx2"
  }),
  PUBLIC_AI_MODULE_CREATOR_ID: str({
    desc: "The canonical root URL for the Reaction Admin server",
    example: "cljmf982j002lyc1lb2otxj8n"
  }),
  PUBLIC_AI_TOPIC_CREATOR_ID: str({
    desc: "The canonical root URL for the Reaction Admin server",
    example: "cljo24aat0005t91kq3metjfm"
  }),
})