...
export default function AdmissionsCurrent({ data, image, duration,programName }) {
    ...
    return (
        <Div className="container">
           <Typography variant="h5" sx={{ color: '#2e475D', fontSize: '28px' }}> <b>Current Admissions</b></Typography>
            <Div>
