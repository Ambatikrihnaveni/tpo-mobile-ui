...
export default function CompetitiveFAQs({ FAQdata, handleFaqQuestionChange, handleFaqanswerChange, handleFaqTypeChange, handleAddFAQ, handleDeleteUser, handleAddQuestion, handleDeleteFAQ, }) {

    return (
        <Div>
            <Div style={{ height: '220px', marginLeft: '60px' }}>

                <JumboScrollbar
                    autoHide
                    autoHideDuration={210}
                    autoHideTimeout={530}
                    autoHeightMin={530}
                >
