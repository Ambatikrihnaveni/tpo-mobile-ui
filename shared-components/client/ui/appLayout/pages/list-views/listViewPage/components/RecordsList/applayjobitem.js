...
import ApplyedjobDetails from '../RecordDetail/appliedjobDetails';
...
const ApplayjobItem = ({ record, view }) => {
    ...
    const showJobDetail = React.useCallback(() => {
        showDialog({
            sx: {
                "& .MuiDialog-container": {
                    "& .MuiPaper-root": {
            ...
            content: <ApplyedjobDetails record={record} onClose={hideDialog} />
        })
    }, [showDialog, record]);
    ...
    if (view === "grid") {
        return (
            <JumboGridItem xs={12} sm={6} md={6} lg={4}>
                <Card variant="outlined" elevation={0}>
                    ...
                    <CardContent sx={{ pt: 0 }}>
                        ...
                        <List disablePadding>
                            ...
                            <ListItem sx={{ px: 1.5 }}>
                                <LocationOnIcon sx={{ minWidth: 40, color: "#50c2c9" }}>
                                    <AlternateEmailIcon />
                                </LocationOnIcon>
                                <ListItemText
                            ...
                            <ListItem sx={{ px: 1.5 }}>
                                <IntegrationInstructionsIcon sx={{ minWidth: 40, color: "#50c2c9" }}>
                                    <PhoneIcon />
                                </IntegrationInstructionsIcon>
                                <ListItemText
                                    primary={record.platform}//record.score
                                />
                            </ListItem >
                            <ListItem sx={{ px: 1.5 }}>
                                <SportsScoreIcon sx={{ minWidth: 50, color: "#50c2c9", marginTop: "-70px",marginLeft:"-8px"}}>
                                    <CalendarMonthIcon />
                                </SportsScoreIcon>
                                <ListItemText
                                    sx={{
                            ...
                            <ListItem style={{ marginTop: "-80px" }}>
                                <CalendarMonthIcon sx={{ minWidth: 50, color: "#50c2c9", marginTop: "-70px",marginLeft:"-9px"}}>
                                    <CalendarMonthIcon />
                                </CalendarMonthIcon>
                                <ListItemText
                                    sx={{
                ...
                >
                    <Button variant="contained" onClick={showJobDetail} sx={{ borderRadius: "50px", color: 'warning', borderColor: 'blue' }} >  Applied</Button>
                </Item>
                    </CardContent>
                </Card>
            </JumboGridItem>
    ...
    return (
        <React.Fragment>
            ...
            >
                    ...
                    primary={
                        <Typography variant={"body1"} component={"div"}>
                            ...
                            <Item
                                ...
                                >
                                    <Typography variant={"h5"} fontSize={14} lineHeight={1.25} mb={0} onClick={showJobDetail}
                ...
                >
                    <Button variant="contained" onClick={showJobDetail} sx={{ borderRadius: "50px", marginLeft: "60px", color: 'warning', borderColor: 'blue' }} >  Applied</Button>
