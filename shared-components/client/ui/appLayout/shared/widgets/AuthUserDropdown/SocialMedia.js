...
export default function SocialMedia( {addLink, addAccount, mediaList,handleAddMedia,handleDeleteMedia}) {
                ...
                <div>
                      <Div>
                        ...
                        <Grid container spacing={1} style={{ marginLeft: '2px' }}    key={index} >
                          ...
                          <Grid item xs={2.5}>                            
                          <Typography style={{ color: '#2e475D', fontFamily: '"Nunito",sans-serif', fontSize: 'smaller', marginBottom: '10px', fontWeight: 'bold',marginTop:'10px' }}>Account *</Typography>
                          ...
                          <Grid item xs={1}>
                           {mediaList.length > 1 && (
                           <DeleteOutlineOutlinedIcon style={{color:'#f24b64',marginTop:'40px',fontSize:'25px'}} onClick={() => handleDeleteMedia(index)}/>
                           )}
                           </Grid>
