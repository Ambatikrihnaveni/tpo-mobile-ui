...
export default function CertifiTemp_3({ logo, authority, studentName, trainingpartnerName, programName, startDate, endDate, programType,record }) {
    let type = ''
    if (programType) {
        ...
        <div>
            <Div>
                <Div sx={{ textAlign: 'center' }}>
                    <img src={logo ? logo : '/logo192.png'} width='100px' height='60px' />
                </Div>
                <Typography
                    sx={{
                        fontSize: '40px',
            ...
            <Div sx={{ mt: 4 }}>
                ...
                <Div sx={{ textAlign: 'center', mt: 2 }}>
                    <img src={'/logo192.png'} width='100px' height='50px' style={{ padding: '0px 10px' }} />
                    <img src={'/prahanSoft.png'} width='100px' height='50px' style={{ padding: '0px 10px' }} />
                </Div>
            </Div>
        </div>
    )
