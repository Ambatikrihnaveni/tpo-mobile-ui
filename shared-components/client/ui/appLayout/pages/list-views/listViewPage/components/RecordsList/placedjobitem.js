...
const PlacedjobItem = ({ record, view }) => {
    ;
                ...
                <Card variant="outlined" elevation={0}>
                    ...
                    <CardContent sx={{ pt: 0 }}>
                        ...
                        >
                            ...
                            >
                                <Button variant="contained" color={buttonText == "Placed" ? "success" : buttonText == "Apply" ? "warning" : buttonText == "Applied" ? "primary" : 'error'} onClick={showtutorDetail} style={{ textTransform: 'none', borderRadius: '15px', minWidth: '100px', marginTop: "15px" }}>Placed</Button>
                            </Item>
                        </Div>
                    </CardContent>
                </Card>
    ...
    return (
        <React.Fragment>
            ...
            >
                ...
                >
                    <Button variant="contained" onClick={showJobDetail} sx={{ borderRadius: '15px', minWidth: '100px', marginLeft: "60px", backgroundColor: "#07bc5c" }}>  Placed</Button>
