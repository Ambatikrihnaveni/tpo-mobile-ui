...
const DashboardPaymentHistoryItem = ({ item, viewer }) => {
    ...
    return (
        <StyledTableRow key={item}>
            ...
            {(viewer?.role === "College-Admin") &&
                <>
                    <TableCell>{truncateGroup}</TableCell>
                    <TableCell>{item?.studentData || item?.students}</TableCell>
                </>
            }
...
export default DashboardPaymentHistoryItem;
