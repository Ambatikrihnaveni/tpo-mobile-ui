...
const ProfileBankDetails = () => {
    ...
    const accountName =viewer?.profile?.accountName
    const accountNumber = viewer?.profile?.accountNumber
    const branch = viewer?.profile?.branch
    const ifscCode = viewer?.profile?.ifscCode
    const bankName = viewer?.profile?.bankName
